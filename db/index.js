...
export const DATABASE = {
  ...
  Hemorrhoids: {
    ...
    questions: [
      ...
      {
        question:
          "Do you have uncomfortable lump(s) or swelling near your anus?",
        answers: ["yes", "no", "not sure"],
        correct: "yes",
      },
      {
        question:
          "Do you feel aches or pain around the anus, especially when sitting?",
        answers: ["yes", "no", "not sure"],
        correct: "yes",
      },
      {
      ...
      {
        question:
          "Do you feel/see skin sticking out of your anus after you poo?",
        answers: ["yes", "no", "not sure"],
        correct: "yes",
      },
    ],
  ...
  Arthritis: {
    ...
    description:
      "Arthritis is an inflammation of the joints. It can affect one joint or multiple joints. Arthritis is an inflammation of the joints. It can affect one joint or multiple joints.",
    result: 0,
    idx: 0,
    questions: [
      {
      ...
      {
        question:
          "Do you feel stiffness or difficulty moving some parts of your body?",
        answers: ["yes", "no", "not sure"],
        correct: "yes",
      },
      {
  ...
  Bronchitis: {
    ...
    questions: [
      ...
      {
        question:
          "Do you have a cough that may bring up mucus that is clear, white, yellow, or green?",
        answers: ["yes", "no", "not sure"],
        correct: "yes",
      },
      {
      ...
      {
        question:
          "Do you feel a Wheezing or a whistling sound when you breathe?",
        answers: ["yes", "no", "not sure"],
        correct: "yes",
      },
      {
  ...
  Gastritis: {
    ...
    questions: [
      ...
      {
        question:
          "Do you feel fullness in your upper abdomen, particularly after eating?",
        answers: ["yes", "no", "not sure"],
        correct: "yes",
      },
      {
  ...
  Herpes: {
    ...
    questions: [
      ...
      {
        question:
          "Do you have blisters on your buttocks (near or around the anus)?",
        answers: ["yes", "no", "not sure"],
        correct: "yes",
      },
      {
